    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Entri Posisi dan Status Dokumen di Entri</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h4 class="card-title">Detail Data Posisi Dokumen Entri :</h4>                         
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('alurentri.updateselfrekap',$alurdokumen->id) }}" id="form-alokasi-doc-pengolahan" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
<!-- sjdkasj -->
                                <div class="card-body">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <strong>Tgl Selesai Entri :</strong>
                                        <input type="date" name="tgl_selesai_entri" class="form-control">
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="checkbox">Dengan ini saya menyatakan bahwa dokumen dengan kode NBS di atas telah selesai saya lakukan editing coding.</label><br>
                                    </div>
